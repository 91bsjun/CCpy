...
class SiteProjectedBand():
    ...
    def parsing_procar(self, filename="PROCAR", sites=None, orbital_index=None):
        ...
        return all_kpts, pmg_eigenval, pmg_conts
    ...
    def get_band_structure(self, kpoints_filename="KPOINTS", procar_filename="PROCAR",
        ...
        kpoints, eigenvals, occupancy = self.parsing_procar(filename=procar_filename, sites=sites)
...
if __name__ == "__main__":
    ...
    bands, occupancy, sites = cls_site_band.get_band_structure(kpoints_filename="./Band-DOS/KPOINTS",
    ...
    plotter.get_site_projected_plot(zero_to_efermi=True, line_width=2, occupancy=occupancy)
