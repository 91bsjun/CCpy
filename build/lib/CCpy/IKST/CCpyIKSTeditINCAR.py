#!/usr/bin/env python
# This script is for adding MAGMOM and LDA+U parameters in each INCAR file.
import os, sys
...
# holee
#mag = {"Ni":4.5, "Mn":4.5, "Co":4.5, "Li":0.0, "O":0.0, "Nb":4.5, "Ti":4.5}
#LDAUL = {"Ni":2, "Mn":2, "Co":2, "Li":2, "O":2, "Ti":2, "Nb":2}
#LDAUU = {"Ni":7.37, "Mn":5.84, "Co":6.14, "Li":0, "O":0, "Ti":3.5, "Nb":2.5}
#LDAUJ = {"Ni":1, "Mn":1, "Co":1, "Li":0, "O":0, "Ti":1, "Nb":1}
